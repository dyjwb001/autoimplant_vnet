...
class UpTransition(nn.Module):
    ...
    def forward(self, x):
        up = self.relu1(self.bn1(self.up_conv(x)))
        out = self.do1(up)
        out = self.ops(out)
...
class VNet(nn.Module):
    ...
    def __init__(self, elu=True, nll=False):
        ...
        self.up_tr128 = UpTransition(256, 64, 2, elu, dropout=True)
        self.up_tr64 = UpTransition(128, 32, 1, elu)
        self.up_tr32 = UpTransition(64, 16, 1, elu)
